...
pub use commands::{
    ...
    google_disconnect, has_anthropic_key, has_gemini_key, has_groq_key, list_mic_devices,
    list_ollama_models, list_smart_functions, mark_action_streaming, open_smart_functions_dir,
    pull_ollama_model, schedule_action_streaming_clear, set_active_conversation, set_anthropic_key,
    set_gemini_key, set_groq_key, set_settings, snapshot_conversation, sync_autostart,
    ActiveConversation, GoogleStatus, InjectResult, PttStateReport, ACTION_POPUP_STREAMING,
