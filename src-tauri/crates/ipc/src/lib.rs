...
pub use commands::{
    ...
    append_user_turn, check_hf_cached, clear_action_streaming, clear_active_conversation,
    clear_anthropic_key, clear_gemini_key, clear_groq_key, get_settings, google_connect,
