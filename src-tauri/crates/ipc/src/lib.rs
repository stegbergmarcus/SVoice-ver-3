...
pub use commands::{
    ...
    has_anthropic_key, has_gemini_key, has_groq_key, list_mic_devices, list_ollama_models,
    list_smart_functions, mark_action_streaming, open_smart_functions_dir, pull_ollama_model,
